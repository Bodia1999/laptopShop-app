...
function setOrderToTable(order) {
    ...
    tableOfOrders.append('<tr>' +
        '<td>' + order.id + '</td>' +
        '<td>' + getCustomerId(order) + '</td>' +
        '<td>' + order.subtotal + '</td>' +
        '<td>' + order.orderTime + '</td>' +
        '<td>' + getAllProductsId(order) + '</td>' +
...
function getCustomerId(order){
    let idCustomerArray = new Array();
    for (let productOrder of order.productForOrder){
        idCustomerArray.push(productOrder.customerResponse.id);
        break;
    }
return idCustomerArray;
}

function getAllProductsId(order) {
    let idArray = new Array();
    for (let productOrder of order.productForOrder){
        idArray.push(productOrder.id);
